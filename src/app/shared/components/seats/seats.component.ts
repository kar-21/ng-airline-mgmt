    ...
    this.passangers.forEach((passanger: PassangerList) => {
      ...
      if (this.type === 'checkin') {
        this.seatsArray[row][column] = [
          passanger,
          passanger.checkedIn ? SharedContants.text.checkedIn : SharedContants.text.notCheckedIn,
          passanger.wheelChair ? SharedContants.text.wheelChair : SharedContants.text.noWheelChair,
          passanger.infants ? SharedContants.text.infants : SharedContants.text.noInfants,
        ];
      } else {
