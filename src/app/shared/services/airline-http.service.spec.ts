...
describe('AirlineHttpService', () => {
  ...
  it('should get passanger list List', () => {
    ...
    const req = httpMock.expectOne(environment.backendAPI + '/getPassangers/flightNumber');
    expect(req.request.method).toBe('GET');
  });

  it('should update airline details', () => {
    service.updateAirlineDetailsFromKey('flightNumber', { key: 'value' }).subscribe(() => {});
    const req = httpMock.expectOne(environment.backendAPI + '/updateAirlineList');
